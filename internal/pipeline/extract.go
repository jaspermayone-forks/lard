...
- kind "area": one subject per project or ongoing thing. name = a short slug of the project (e.g. "crush", "battleship-arena"). Facts about what a project is, its conventions, decisions, architecture. "user is a developer of X" is an area fact for X, NOT profile.
...
- kind "people": one subject per person. name = a slug of their name.
...
- Durable only. Skip anything true only for this task or hour.
- One clear statement per fact; group tightly-related details into one fact rather than splitting hairs.
- Prefer durable phrasing over specifics that go stale ("meeting-heavy mornings" > "10:00 standup").
